...
class PluginInfo:
    ...
    # config is a YAML::Node in C++; exposed here as a YAML-document string.
    @property
    def config(self) -> str: ...
...
class PluginInfoContainer:
    def __init__(self) -> None: ...

    @property
    def default_plugin(self) -> str: ...

    @default_plugin.setter
    def default_plugin(self, arg: str, /) -> None: ...

    @property
    def plugins(self) -> dict[str, PluginInfo]: ...

    @plugins.setter
    def plugins(self, arg: dict[str, PluginInfo], /) -> None: ...

    def clear(self) -> None: ...

class KinematicsPluginInfo:
    def __init__(self) -> None: ...
    ...
    @search_paths.setter
    def search_paths(self, arg: list[str], /) -> None: ...

    @property
    def search_libraries(self) -> list[str]: ...

    @search_libraries.setter
    def search_libraries(self, arg: list[str], /) -> None: ...

    @property
    def fwd_plugin_infos(self) -> dict[str, PluginInfoContainer]: ...

    @fwd_plugin_infos.setter
    def fwd_plugin_infos(self, arg: dict[str, PluginInfoContainer], /) -> None: ...

    @property
    def inv_plugin_infos(self) -> dict[str, PluginInfoContainer]: ...

    @inv_plugin_infos.setter
    def inv_plugin_infos(self, arg: dict[str, PluginInfoContainer], /) -> None: ...

    def insert(self, other: KinematicsPluginInfo) -> None: ...
