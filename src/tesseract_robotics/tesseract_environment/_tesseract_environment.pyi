...
class AddLinkCommand(Command):
    @overload
    def __init__(self, link: tesseract_robotics.tesseract_scene_graph._tesseract_scene_graph.Link, replace_allowed: bool = False) -> None: ...

    @overload
    def __init__(self, link: tesseract_robotics.tesseract_scene_graph._tesseract_scene_graph.Link, joint: tesseract_robotics.tesseract_scene_graph._tesseract_scene_graph.Joint, replace_allowed: bool = False) -> None: ...
...
class AddSceneGraphCommand(Command):
    @overload
    def __init__(self, scene_graph: tesseract_robotics.tesseract_scene_graph._tesseract_scene_graph.SceneGraph, prefix: str = '') -> None: ...

    @overload
    def __init__(self, scene_graph: tesseract_robotics.tesseract_scene_graph._tesseract_scene_graph.SceneGraph, joint: tesseract_robotics.tesseract_scene_graph._tesseract_scene_graph.Joint, prefix: str = '') -> None: ...

    def getSceneGraph(self) -> tesseract_robotics.tesseract_scene_graph._tesseract_scene_graph.SceneGraph: ...
...
class ChangeCollisionMarginsCommand(Command):
    ...
    @overload
    def __init__(self, pair_margin_data: tesseract_robotics.tesseract_common._tesseract_common.CollisionMarginPairData, override_type: tesseract_robotics.tesseract_common._tesseract_common.CollisionMarginPairOverrideType = tesseract_robotics.tesseract_common._tesseract_common.CollisionMarginPairOverrideType.REPLACE) -> None: ...

    def getDefaultCollisionMargin(self) -> float | None: ...

    def getCollisionMarginPairData(self) -> tesseract_robotics.tesseract_common._tesseract_common.CollisionMarginPairData: ...

    def getCollisionMarginPairOverrideType(self) -> tesseract_robotics.tesseract_common._tesseract_common.CollisionMarginPairOverrideType: ...
...
class ChangeJointOriginCommand(Command):
    def __init__(self, joint_name: str, origin: tesseract_robotics.tesseract_common._tesseract_common.Isometry3d) -> None: ...
...
class ChangeLinkOriginCommand(Command):
    def __init__(self, link_name: str, origin: tesseract_robotics.tesseract_common._tesseract_common.Isometry3d) -> None: ...
...
class MoveLinkCommand(Command):
    def __init__(self, joint: tesseract_robotics.tesseract_scene_graph._tesseract_scene_graph.Joint) -> None: ...
...
class Environment:
    ...
    @overload
    def init(self, scene_graph: tesseract_robotics.tesseract_scene_graph._tesseract_scene_graph.SceneGraph) -> bool: ...

    @overload
    def init(self, scene_graph: tesseract_robotics.tesseract_scene_graph._tesseract_scene_graph.SceneGraph, srdf: tesseract_robotics.tesseract_srdf._tesseract_srdf.SRDFModel) -> bool: ...

    @overload
    def init(self, urdf_path: str, srdf_path: str, locator: tesseract_robotics.tesseract_common._tesseract_common.ResourceLocator) -> bool: ...

    @overload
    def init(self, urdf_or_path: str, locator: tesseract_robotics.tesseract_common._tesseract_common.ResourceLocator) -> bool: ...

    def initFromUrdf(self, urdf_string: str, locator: tesseract_robotics.tesseract_common._tesseract_common.ResourceLocator) -> bool: ...

    def initFromUrdfSrdf(self, urdf_string: str, srdf_string: str, locator: tesseract_robotics.tesseract_common._tesseract_common.ResourceLocator) -> bool: ...
    ...
    def getState(self) -> tesseract_robotics.tesseract_state_solver._tesseract_state_solver.SceneState: ...

    def getStateByMap(self, joints: Mapping[str, float]) -> tesseract_robotics.tesseract_state_solver._tesseract_state_solver.SceneState: ...

    def getStateByNamesAndValues(self, joint_names: Sequence[str], joint_values: Annotated[NDArray[numpy.float64], dict(shape=(None,), writable=False)]) -> tesseract_robotics.tesseract_state_solver._tesseract_state_solver.SceneState: ...

    @overload
    def setState(self, joints: Mapping[str, float]) -> None: ...

    @overload
    def setState(self, joint_names: Sequence[str], joint_values: Annotated[NDArray[numpy.float64], dict(shape=(None,), writable=False)]) -> None: ...
    ...
    def getCurrentJointValues(self) -> Annotated[NDArray[numpy.float64], dict(shape=(None,), order='C')]: ...

    def getCurrentJointValuesByNames(self, joint_names: Sequence[str]) -> Annotated[NDArray[numpy.float64], dict(shape=(None,), order='C')]: ...
    ...
    def getJoint(self, name: str) -> tesseract_robotics.tesseract_scene_graph._tesseract_scene_graph.Joint: ...

    def getGroupNames(self) -> set[str]: ...

    def getGroupJointNames(self, group_name: str) -> list[str]: ...

    def getJointGroup(self, group_name: str) -> tesseract_robotics.tesseract_kinematics._tesseract_kinematics.JointGroup: ...

    def getKinematicGroup(self, group_name: str, ik_solver_name: str = '') -> tesseract_robotics.tesseract_kinematics._tesseract_kinematics.KinematicGroup: ...
    ...
    def getContinuousContactManager(self) -> tesseract_robotics.tesseract_collision._tesseract_collision.ContinuousContactManager: ...

    def setActiveDiscreteContactManager(self, name: str) -> bool: ...

    def setActiveContinuousContactManager(self, name: str) -> bool: ...

    def clearCachedDiscreteContactManager(self) -> None: ...

    def clearCachedContinuousContactManager(self) -> None: ...

    def getAllowedCollisionMatrix(self) -> tesseract_robotics.tesseract_common._tesseract_common.AllowedCollisionMatrix: ...

    def getCollisionMarginData(self) -> tesseract_robotics.tesseract_common._tesseract_common.CollisionMarginData: ...

    def setResourceLocator(self, locator: tesseract_robotics.tesseract_common._tesseract_common.ResourceLocator) -> None: ...

    def getResourceLocator(self) -> tesseract_robotics.tesseract_common._tesseract_common.ResourceLocator: ...
